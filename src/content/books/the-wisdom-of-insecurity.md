...
- There are, then, two ways of understanding an experience
  1. compare it with the memories of other experiences, and so to name and define it. This is to interpret it in accordance with the dead and the past.
  2. be aware of it as it is, as when, in the intensity of joy, we forget past and future, let the present be all, even stop to think, "I am happy.
